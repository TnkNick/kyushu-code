...
const ICON_PATHS = {
  ...
  gear: (
    <>
      ...
      <path d="M19.4 13.5a7.5 7.5 0 0 0 0-3l1.8-1.4-1.5-2.6-2.1.8a7.5 7.5 0 0 0-2.6-1.5L14.6 3h-3l-.4 2.3A7.5 7.5 0 0 0 8.6 6.8L6.5 6 5 8.6l1.8 1.4a7.5 7.5 0 0 0 0 3L5 14.4 6.5 17l2.1-.8a7.5 7.5 0 0 0 2.6 1.5l.4 2.3h3l.4-2.3a7.5 7.5 0 0 0 2.6-1.5l2.1.8 1.5-2.6Z" />
    </>
  ),
