    ...
    },
    {
      ...
      activities: [
        ...
        { type: 'step', time: '12:40', meridiem: 'Midday', kind: 'Parking', icon: 'car',
          ...
          place: L('Ichinomiya Central Municipal lot', 'ลานเทศบาลอิจิโนมิยะ'),
          blurb: L('Leave the van in one lot and do the whole stop on foot - the shrine gate is straight ahead of the car park, Monzenmachi runs off to the side, and you finish back at the same lot. Reckon on an hour before you drive back to Uchinomaki for lunch.',
                   'จอดรถไว้ลานเดียวแล้วเดินเที่ยวทั้งจุด - ประตูศาลเจ้าอยู่ตรงหน้าลานจอด ถนนมนเซนมาจิแยกออกไปด้านข้าง เดินจบแล้ววนกลับมาที่ลานเดิม - เผื่อเวลาราวชั่วโมงก่อนขับกลับไปกินข้าวที่อุจิโนมากิ'),
          refs: { map: 'https://maps.google.com/?q=Aso+Ichinomiya+Chuo+Parking',
                  booking: L('¥300 first 3 h, then ¥100/h, ¥1,000 cap', '¥300 3 ชม.แรก แล้ว ¥100/ชม. สูงสุด ¥1,000'),
                  notes: L('Pick this lot, not the shrine own ones - the city page and the national roadside database disagree about whether those are paid or free, and this is the one sources name as taking larger vehicles. It is the only paid parking of the morning.', 'เลือกลานนี้ ไม่ใช่ลานของศาลเจ้า - เว็บเทศบาลกับฐานข้อมูลจุดจอดของกรมทางหลวงบอกไม่ตรงกันว่าลานศาลเจ้าเก็บเงินหรือฟรี และลานนี้เป็นลานที่ระบุว่ารับรถคันใหญ่ได้ - เป็นที่เดียวของช่วงเช้าที่ต้องเสียค่าจอด') } },
        ...
        { type: 'feature', time: '20:30', meridiem: 'Night', kind: 'Nightlife', imageId: 'a-d2-nightlife',
          ...
          refs: { map: 'https://maps.google.com/?q=Shichifukujin+Uchinomaki+Aso', official: 'https://www.asocity-kanko.jp/gourmet_category/uchinomaki/',
