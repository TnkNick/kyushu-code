      ...
      activities: [
        ...
        { type: 'feature', time: '15:15', meridiem: 'Afternoon', kind: 'Park', imageId: 'a-d3-kusasenri',
          ...
          refs: { map: 'https://maps.google.com/?q=Kusasenri+Aso', official: 'https://www.aso-volcano.jp/',
                  notes: L('The Nakadake crater road starts just above here, but it is shut - Aso went to eruption alert Level 3 on 14 Aug 2026, closing everything within 2 km of the crater. Kusasenri itself is outside that zone and open as normal. The level moves both ways, so if it drops back to 1 or 2 before you travel, the crater terminal is only a short drive further up and you can add it back on the day.', 'ถนนขึ้นปล่องนากาดาเกะเริ่มเหนือจุดนี้ขึ้นไปนิดเดียว แต่ปิดอยู่ - อาโซขึ้นเป็นเตือนภัยระดับ 3 เมื่อ 14 ส.ค. 2026 ปิดทุกอย่างในรัศมี 2 กม. รอบปากปล่อง - ตัวคุซะเซนริอยู่นอกเขตนั้น เปิดปกติ - ระดับเตือนภัยขึ้นลงได้ ถ้าลดเหลือ 1 หรือ 2 ก่อนไป ปล่องอยู่ห่างจากตรงนี้ขึ้นไปแป๊บเดียว เพิ่มกลับเข้าโปรแกรมหน้างานได้เลย') } },

        { type: 'feature', time: '16:15', meridiem: 'Afternoon', kind: 'Shrine', imageId: 'a-d2-asojinja',
          ...
          blurb: L('Over 2,000 years old, with one of the three great two-storey romon gates in Japan. The gate collapsed in the 2016 earthquake and only reopened in December 2023 after a seven-and-a-half year rebuild that reused about 72% of the original timbers. The street in front, Monzenmachi, has fifteen spring-water fountains and is made for eating your way along it.',
                   'ศาลเจ้าอายุกว่า 2,000 ปี มีประตูโรมงสองชั้นที่ถือเป็นหนึ่งในสามประตูศาลเจ้ายิ่งใหญ่ที่สุดของญี่ปุ่น - ประตูพังตอนแผ่นดินไหวปี 2016 และเพิ่งเปิดใหม่ธันวาคม 2023 หลังบูรณะ 7 ปีครึ่ง โดยใช้ไม้เดิมกลับมาได้ราว 72% - ถนนหน้าศาลเจ้าชื่อมนเซนมาจิ มีจุดน้ำผุด "มิซุกิ" 15 จุด และเป็นถนนสำหรับเดินกินโดยเฉพาะ'),
          refs: { map: 'https://maps.google.com/?q=Aso+Shrine+Ichinomiya', official: 'https://asojinja.or.jp/',
                  booking: L('Free', 'เข้าฟรี'),
                  notes: L('This replaces the Nakadake crater, which is shut at Level 3. It is about 9 km east of Uchinomaki and sits where Route 212 turns north for Oguni and Kurokawa, so it is on the way out rather than a detour. The shrine grounds stay open late but the Monzenmachi shops mostly shut around 17:00 - if you want the food street properly, do this during the Imakin queue instead of after Kusasenri.',
                           'จุดนี้มาแทนปล่องนากาดาเกะที่ปิดอยู่ (ระดับ 3) - อยู่ห่างอุจิโนมากิไปทางตะวันออกราว 9 กม. และอยู่ตรงจุดที่เส้น 212 เลี้ยวขึ้นเหนือไปโอกุนิกับคุโรคาวะ จึงอยู่บนทางออกพอดี ไม่ใช่ทางอ้อม - บริเวณศาลเจ้าเปิดถึงเย็น แต่ร้านบนถนนมนเซนมาจิส่วนใหญ่ปิดราว 17:00 - ถ้าอยากเดินกินให้เต็มที่ ให้ย้ายมาทำช่วงรอคิวร้านอิมาคิงแทน') } },
        ...
        { type: 'step', time: '18:00', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          ...
          blurb: L('Leave the caldera north for Kurokawa, a cedar-lined gorge of thatched inns widely rated one of the loveliest onsen villages in Japan. About 45 min on from Aso Shrine - and it puts you on the Yamanami Highway, so tomorrow\'s run to Beppu drops from ~2 h to about 1 h 10. Tell the ryokan you will arrive around 18:00, since dinner is usually served from 18:00-19:00.',
                   'ออกจากปากปล่องขึ้นเหนือสู่คุโรคาวะ หุบเขาต้นซีดาร์ที่มีเรียวกังหลังคาฟาง ได้ชื่อว่าเป็นหมู่บ้านออนเซนที่สวยที่สุดแห่งหนึ่งของญี่ปุ่น - ห่างจากศาลเจ้าอาโซราว 45 นาที และอยู่บนเส้นยามานามิพอดี พรุ่งนี้ขับไปเบปปุจึงเหลือราว 1 ชม. 10 นาที จากเดิม ~2 ชม. - แจ้งเรียวกังด้วยว่าจะถึงราว 18:00 เพราะมื้อค่ำมักเริ่ม 18:00-19:00'),
