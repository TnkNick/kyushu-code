...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      note: L(
        'Pick up the car in Hakata and climb the Milk Road into the largest caldera in Japan. Late November is past the maple season up here - what you get instead is the grassland at its best: bleached-gold slopes and silver susuki plumes across the rim - then check in to an onsen ryokan by the caldera: red-wagyu dinner and dark-sky stars.',
        'รับรถที่ฮากาตะแล้วไต่เส้น Milk Road ขึ้นสู่ปากปล่องภูเขาไฟที่ใหญ่ที่สุดในญี่ปุ่น - ปลายพฤศจิกายนเลยฤดูใบเมเปิลบนนี้ไปแล้ว สิ่งที่ได้แทนคือทุ่งหญ้าในช่วงสวยที่สุด: เนินหญ้าสีทองซีดกับปุยหญ้าซูซูกิสีเงินทั่วขอบปล่อง - แล้วเข้าพักเรียวกังออนเซนริมปากปล่อง: มื้อค่ำเนื้อวากิวแดงและนอนดูดาว'
      ),
      coverId: 'day2-cover',
      activities: [
        ...
        { type: 'feature', time: '15:00', meridiem: 'Afternoon', kind: 'Park', imageId: 'a-d3-kusasenri',
          ...
          blurb: L('A wide meadow with twin crater ponds right under Nakadake - horses graze in summer; in late November it is pale gold kusa-momiji grass and silver susuki under a big sky. This is the classic autumn Aso photo, and it stays open even when the crater itself is closed.',
                   'ทุ่งหญ้ากว้างมีบ่อปล่องคู่อยู่ใต้นากาดาเกะพอดี - หน้าร้อนมีม้าเล็มหญ้า - ปลายพฤศจิกายนเป็นทุ่งหญ้าสีทองซีดกับหญ้าซูซูกิสีเงินใต้ฟ้ากว้าง เป็นภาพอาโซหน้าใบไม้เปลี่ยนสีแบบคลาสสิก และยังเข้าได้แม้ปากปล่องจะปิด'),
        ...
        { type: 'feature', time: '15:45', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d3-nakadake',
          ...
          blurb: L('A turquoise crater lake hissing sulphurous steam - normally the highlight of the caldera, but CURRENTLY CLOSED: Aso was raised to eruption alert Level 3 on 14 Aug 2026, banning entry within 2 km of the crater. Treat this stop as optional until you have re-checked.',
                   'ทะเลสาบปากปล่องสีเทอร์คอยซ์พ่นไอกำมะถัน - ปกติคือไฮไลต์ของปากปล่อง แต่ตอนนี้ปิด: อาโซถูกยกระดับเตือนภัยภูเขาไฟเป็นระดับ 3 เมื่อ 14 ส.ค. 2026 ห้ามเข้าในรัศมี 2 กม. รอบปากปล่อง - ให้ถือว่าจุดนี้เป็นตัวเลือกจนกว่าจะเช็กใหม่'),
          refs: { map: 'https://maps.google.com/?q=Nakadake+Crater+Aso', official: 'https://www.aso-volcano.jp/',
                  notes: L('CHECK BEFORE YOU GO. Level 3 (as of late Aug 2026) closes the crater, the summit terminal and the shuttle bus; Kusasenri, Komezuka and Daikanbo are all outside the 2 km zone and stay open. The level moves both ways - it was 1, then 2, then 3 within a year - so re-check the official page in the days before the drive. If it is open, the normal November gate hours are 08:30-17:30 (last entry 17:00) and it can still shut at short notice on a high-gas reading.', 'เช็กก่อนไป - ระดับ 3 (ณ ปลาย ส.ค. 2026) ปิดปากปล่อง อาคารบนยอด และรถชัตเทิล แต่คุซะเซนริ โคเมซึกะ ไดคันโบ อยู่นอกรัศมี 2 กม. ยังเข้าได้ปกติ - ระดับเตือนภัยขึ้นลงได้ (ปีเดียวเปลี่ยนจาก 1 เป็น 2 เป็น 3) เช็กเว็บทางการอีกทีก่อนวันขับขึ้นไป - ถ้าเปิด เวลาปกติเดือน พ.ย. คือ 08:30-17:30 (เข้าได้ถึง 17:00) และยังปิดกะทันหันได้ถ้าแก๊สสูง') } },

        { type: 'step', time: '17:30', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          title: L('Check in - Aso onsen ryokan', 'เช็คอิน - เรียวกังออนเซนอาโซ'),
          place: L('One night - by the caldera', 'หนึ่งคืน - ริมปากปล่อง'),
          blurb: L('Come down off the caldera to an onsen ryokan around Aso / Uchinomaki - soak after the volcano day and sleep under some of Kyushu\'s darkest skies.',
                   'ลงจากปากปล่องมาพักเรียวกังออนเซนแถบอาโซ / อุจิโนมากิ - แช่น้ำหลังเที่ยวภูเขาไฟ แล้วนอนใต้ฟ้าที่มืดที่สุดแห่งหนึ่งของคิวชู'),
          refs: { map: 'https://maps.google.com/?q=Aso+onsen+ryokan', reservation: { time: '17:30', code: 'ASO-RYO', party: L('Night 2 - 1 night - to book', 'คืน 2 - 1 คืน - รอจอง') }, notes: L('NOT BOOKED YET - and this is the most urgent one: Mon 23 Nov is Labour Thanksgiving Day in Japan, so 21-23 Nov is a three-day weekend and the ryokan will fill. Three candidates in Uchinomaki Onsen: (1) Yumeoisou, yumeoisou.com - the best group fit, 5-person rooms (some with their own open-air bath), around 15 free private family baths, 100 free parking spaces, akaushi on the buffet; (2) Sozankyo, sozankyo.com/en - has an English site and an akaushi lava-grilled kaiseki, plus one 5-person connected room called Higotai; (3) Aso Hotel, asohotel.jp/en - cheapest of the three, rooftop open-air bath with the star view, but no room sleeps more than 4. Prices online are indicative ranges, not quotes for these dates - email them with the exact date, headcount, the akaushi dinner and the 8-seat van.', 'ยังไม่จอง - และเป็นคืนที่เร่งที่สุด เพราะ 23 พ.ย. เป็นวันขอบคุณแรงงานของญี่ปุ่น 21-23 พ.ย. จึงเป็นวันหยุดยาว 3 วัน เรียวกังจะเต็ม - ตัวเลือก 3 ที่ในย่านออนเซนอุจิโนมากิ: (1) Yumeoisou (yumeoisou.com) เหมาะกับกลุ่มที่สุด มีห้องนอน 5 คน (บางห้องมีออนเซนส่วนตัว) บ่อแช่ส่วนตัวแบบครอบครัวฟรีราว 15 บ่อ ที่จอดรถฟรี 100 คัน มีเนื้ออาคาอุชิในบุฟเฟ่ต์ (2) Sozankyo (sozankyo.com/en) มีเว็บภาษาอังกฤษ มีไคเซกิเนื้ออาคาอุชิย่างหินลาวา และมีห้องเชื่อมนอนได้ 5 คนชื่อฮิโกไต (3) Aso Hotel (asohotel.jp/en) ถูกที่สุดในสามที่ มีออนเซนกลางแจ้งบนดาดฟ้าดูดาว แต่ห้องนอนได้สูงสุด 4 คน - ราคาบนเว็บเป็นช่วงราคาโดยประมาณ ไม่ใช่ราคาของวันนี้ - อีเมลถามให้ชัดเรื่องวันที่ จำนวนคน มื้อเย็นอาคาอุชิ และที่จอดรถตู้ 8 ที่นั่ง') } },
        ...
        { type: 'feature', time: '19:00', meridiem: 'Night', kind: 'Dining', imageId: 'a-d2-dinner',
          ...
          place: L('Ryokan kaiseki or a local grill', 'ไคเซกิเรียวกัง หรือร้านปิ้งย่างท้องถิ่น'),
          blurb: L('Dinner built around Aso red-wagyu (akaushi) - the ryokan\'s kaiseki course or a nearby grill: lean, grassy beef raised on the caldera pastures.',
                   'มื้อค่ำเน้นเนื้อวากิวแดง (อากาอุชิ) ของอาโซ - คอร์สไคเซกิของเรียวกัง หรือร้านปิ้งย่างใกล้ๆ: เนื้อไม่ติดมัน เลี้ยงบนทุ่งหญ้าปากปล่อง'),
          refs: { map: 'https://maps.google.com/?q=Aso+akaushi+restaurant' } },

        { type: 'feature', time: '20:30', meridiem: 'Night', kind: 'View', imageId: 'a-d2-nightlife',
          title: L('Onsen & a sky full of stars', 'ออนเซน & ฟ้าดาวเต็มฟ้า'),
          place: L('Aso caldera - dark skies', 'ปากปล่องอาโซ - ฟ้ามืดเห็นดาว'),
          blurb: L('No nightlife strip up here - soak in the open-air bath, then step out for the stars. The Aso caldera is one of Kyushu\'s best dark-sky spots on a clear late-autumn night - dress warm, it drops close to freezing up here after dark.',
                   'บนนี้ไม่มีย่านกลางคืน - แช่ออนเซนกลางแจ้งแล้วออกมาดูดาว - ปากปล่องอาโซเป็นจุดดูดาวที่ดีที่สุดแห่งหนึ่งของคิวชูในคืนปลายฤดูใบไม้ร่วงฟ้าใส - ใส่เสื้อกันหนาวด้วย กลางคืนบนนี้ใกล้จุดเยือกแข็ง'),
          refs: { map: 'https://maps.google.com/?q=Aso+star+gazing' } },
      ],
    },
    {
      ...
      activities: [
        { type: 'step', time: '08:30', meridiem: 'Morning', kind: 'Check-out', icon: 'luggage',
          title: L('Check out - Aso ryokan', 'เช็คเอาท์ - เรียวกังอาโซ'),
          place: L('One night done - onward to the coast', 'ครบหนึ่งคืน - มุ่งสู่ชายฝั่ง'),
          blurb: L('A morning soak and breakfast, then load the car - the scenic Yamanami Highway down to Beppu lies ahead.',
                   'แช่น้ำเช้าและกินอาหารเช้า แล้วขนของขึ้นรถ - รออยู่คือยามานามิไฮเวย์วิวสวยลงสู่เบปปุ'),
          refs: { map: 'https://maps.google.com/?q=Aso+onsen+ryokan', notes: L('Check-out ~10:00 - one night at Aso.', 'เช็คเอาท์ ~10:00 - พักอาโซ 1 คืน') } },

        { type: 'step', time: '09:00', meridiem: 'Morning', kind: 'Transfer', icon: 'car',
          title: L('Drive via Yamanami Highway', 'ขับผ่านยามานามิไฮเวย์'),
          place: L('Aso -> Beppu - ~2 h', 'อาโซ -> เบปปุ - ~2 ชม.'),
          blurb: L('A ribbon of road over rolling volcanic moorland from Aso down to the eastern coast.',
                   'ถนนสายโค้งทอดข้ามทุ่งภูเขาไฟลูกคลื่นจากอาโซลงสู่ชายฝั่งตะวันออก'),
          refs: { map: 'https://maps.google.com/?q=Yamanami+Highway',
                  notes: L('Optional detour: Takachiho Gorge - and it is the single best-timed foliage stop of the trip, peaking mid-to-late November with an evening light-up (18:00-22:00) that runs to the end of the month. It adds real driving time and gets crowded in this exact season, so only take it if you start early.', 'แวะเสริมได้: หุบเขาทาคาชิโฮะ - เป็นจุดใบไม้เปลี่ยนสีที่ตรงช่วงที่สุดของทริปนี้ พีคกลางถึงปลายพฤศจิกายน มีไลต์อัพตอนเย็น (18:00-22:00) ถึงสิ้นเดือน - แต่ใช้เวลาขับเพิ่มเยอะและคนแน่นมากในช่วงนี้ เอาไว้ถ้าออกเช้าจริงๆ') } },
...
const KONBINI = {
  ...
  areas: [
    ...
    { days: L('Day 02', 'วันที่ 02'), area: L('Aso - Uchinomaki', 'อาโซ - อุจิโนมากิ'),
      stores: [
        { brand: '7-Eleven', detail: L('Uchinomaki / Route 212', 'อุจิโนมากิ / เส้น 212'), map: 'https://maps.google.com/?q=7-Eleven+Uchinomaki+Aso' },
        { brand: 'Lawson', detail: L('Aso Stn area', 'แถวสถานีอาโซ'), map: 'https://maps.google.com/?q=Lawson+Aso+Station' },
      ],
...
const WEATHER = {
  ...
  days: {
    ...
    4:  { icon: 'cloudSun', hi: 17, lo: 9, label: L('Mild by the coast', 'อากาศดีริมชายฝั่ง') },
