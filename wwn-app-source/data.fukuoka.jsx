      ...
      activities: [
        ...
        { type: 'step', time: '12:15', meridiem: 'Midday', kind: 'Transfer', icon: 'car',
          ...
          refs: { map: 'https://maps.google.com/?q=Imakin+Shokudo+Aso',
                  parking: L('Three small lots rather than one big one: about 6 spaces opposite the shop, roughly 30 in front of Myokoji temple, and about 30 more a 4-minute walk away. Take the van to one of the bigger two - the kerbside spots are tight. No fee is published anywhere, but the shop does not state it is free either.', 'มีลานเล็กๆ 3 จุด ไม่ใช่ลานใหญ่จุดเดียว: ราว 6 ช่องตรงข้ามร้าน ราว 30 ช่องหน้าวัดเมียวโคจิ และอีกราว 30 ช่องเดิน 4 นาที - เอารถตู้ไปสองลานหลังดีกว่า ริมถนนแคบ - ไม่มีที่ไหนระบุค่าจอด แต่ร้านก็ไม่ได้บอกว่าฟรี'),
        ...
        { type: 'feature', time: '12:30', meridiem: 'Midday', kind: 'Shrine', imageId: 'a-d2-asojinja',
          ...
          refs: { map: 'https://maps.google.com/?q=Aso+Shrine+Ichinomiya', official: 'https://asojinja.or.jp/',
                  ...
                  parking: L('PAID, and the one stop where the lot matters. Aim for the Ichinomiya Central Municipal lot in front of the gate: ¥300 for the first 3 hours, ¥100/hr after, ¥1,000 daily cap - and it is the lot sources name as taking larger vehicles. The shrine has its own lots too, but the town page and the national roadside database disagree about whether those are paid or free, so on a holiday take the municipal one and stop thinking about it.', 'เสียเงิน และเป็นจุดเดียวที่เลือกลานผิดแล้วเสียเวลา - ให้เข้าลานเทศบาลอิจิโนมิยะหน้าประตูศาลเจ้า: ¥300 สำหรับ 3 ชม.แรก ชม.ต่อไป ¥100 สูงสุด ¥1,000/วัน และเป็นลานที่แหล่งข้อมูลระบุว่ารับรถคันใหญ่ได้ - ศาลเจ้ามีลานของตัวเองด้วย แต่เว็บเทศบาลกับฐานข้อมูลจุดจอดของกรมทางหลวงบอกไม่ตรงกันว่าเก็บเงินหรือฟรี วันหยุดยาวเข้าลานเทศบาลไปเลยง่ายกว่า'),
        ...
        { type: 'feature', time: '16:00', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d2-komezuka',
          ...
          refs: { map: 'https://maps.google.com/?q=Komezuka+Aso',
                  parking: L('Free, about 45 spaces at the lower Komezuka lot, then a 5-10 minute walk up to the viewpoint. There is shoulder parking closer to the view along the Panorama Line but it is tiny and goes early at weekends.', 'ฟรี ราว 45 ช่องที่ลานล่างโคเมซึกะ แล้วเดินขึ้นจุดชมวิว 5-10 นาที - มีที่จอดริมไหล่ทางใกล้จุดชมวิวบนพาโนรามาไลน์ แต่น้อยมากและเต็มเร็วช่วงเสาร์อาทิตย์') } },
        ...
        { type: 'feature', time: '16:30', meridiem: 'Afternoon', kind: 'Park', imageId: 'a-d3-kusasenri',
          ...
          refs: { map: 'https://maps.google.com/?q=Kusasenri+Aso', official: 'https://www.aso-volcano.jp/',
                  parking: L('PAID, and this one has a proper published rate: ¥500 a car, ¥2,000 a bus. An 8-seat van is registered as an ordinary passenger car, so you pay ¥500, not the bus rate. Unmanned since 2024 - plate recognition, pay on the way out. There is a small free lot at the overlook nearby but it fills instantly on a holiday.', 'เสียเงิน และมีราคาทางการชัดเจน: รถยนต์ ¥500 รถบัส ¥2,000 - รถตู้ 8 ที่นั่งจดทะเบียนเป็นรถยนต์นั่งธรรมดา จ่าย ¥500 ไม่ใช่เรตรถบัส - ตั้งแต่ปี 2024 เป็นระบบไร้คนดูแล อ่านป้ายทะเบียนแล้วจ่ายตอนออก - มีลานฟรีเล็กๆ ตรงจุดชมวิวใกล้ๆ แต่วันหยุดเต็มทันที'),
