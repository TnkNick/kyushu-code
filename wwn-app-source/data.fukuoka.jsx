  ...
  days: [
    {
      ...
      activities: [
        ...
        { type: 'feature', time: '10:00', meridiem: 'Morning', kind: 'Dining', imageId: 'a-d1-ramen',
    ...
    },
    {
      ...
      activities: [
        ...
        { type: 'feature', time: '21:30', meridiem: 'Night', kind: 'Nightlife', imageId: 'a-d5-bar',
          title: L('Oyafuko-dori bar street', 'ถนนบาร์โอยาฟุโกะ'),
          place: L('Tenjin’s nightlife alley', 'ตรอกกลางคืนเท็นจิน'),
          blurb: L('Tenjin’s classic drinking street — a strip of tiny bars, izakaya and music spots stacked up the buildings. Wander in, grab a counter, and bar-hop your first night back in the city.',
                   'ถนนดื่มคลาสสิกของเท็นจิน — เรียงรายด้วยบาร์เล็กๆ อิซากายะ และร้านดนตรีซ้อนกันขึ้นไปตามตึก · เดินเข้าไปหาเคาน์เตอร์ แล้วบาร์ฮอปคืนแรกที่กลับเข้าเมือง'),
          refs: { map: 'https://maps.google.com/?q=Oyafukodori+Tenjin+Fukuoka', notes: L('Off Tenjin / Daimyo · most spots are small, keep some cash.', 'ใกล้เท็นจิน / ไดเมียว · ร้านส่วนใหญ่เล็ก เตรียมเงินสด') } },
      ],
    },
    {
