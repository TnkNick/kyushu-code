...
const TRIP = {
  ...
  days: [
    ...
    // ───────────────────────── DAY 2 · ASO / KUROKAWA ─────────────────────────
    {
      label: 'Day 02', labelTh: 'วันที่ 02', theme: 'kohaku',
      date: L('Saturday · 5 Dec 2026', 'เสาร์ · 5 Dec 2026'),
      title: L('Kumamoto', 'คุมาโมโตะ'),
      subtitle: L('Pick Up the Car · Castle City', 'รับรถ · เมืองปราสาท'),
      note: L(
        'A dawn run in Fukuoka, then pick up the car and drive south to the castle city of Kumamoto — one of the great fortresses of Japan, a strolling garden, horse sashimi for dinner, and a night in the city.',
        'วิ่งเช้าในฟุกุโอกะ แล้วรับรถขับลงใต้สู่เมืองปราสาทคุมาโมโตะ — หนึ่งในป้อมปราการยิ่งใหญ่ของญี่ปุ่น สวนเดินเล่น ม้าดิบเป็นมื้อค่ำ และค้างคืนในเมือง'
      ),
      coverId: 'day2-cover',
      activities: [
        ...
        { type: 'step', time: '09:30', meridiem: 'Morning', kind: 'Transfer', icon: 'car',
          title: L('Depart for Kumamoto', 'ออกเดินทางไป Kumamoto'),
          place: L('Kyushu Expressway · ~1.5 h', 'ทางด่วนคิวชู · ~1.5 ชม.'),
          blurb: L('Straight south down the expressway past Kurume to the castle city.',
                   'ลงใต้ตรงทางด่วนผ่านคุรุเมะสู่เมืองปราสาท'),
        ...
        { type: 'step', time: '17:30', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          title: L('Check in · Kumamoto hotel', 'เช็คอิน · โรงแรมคุมาโมโตะ'),
          place: L('City hotel · one night', 'โรงแรมในเมือง · หนึ่งคืน'),
          blurb: L('Drop the bags downtown for the night — central, near the castle and the Shimotori arcade.',
                   'เก็บกระเป๋ากลางเมืองค้างหนึ่งคืน — ทำเลกลาง ใกล้ปราสาทและถนนคนเดินชิโมโทริ'),
          refs: { map: 'https://maps.google.com/?q=Kumamoto+city+hotels+Shimotori', reservation: { time: '17:30', code: 'KMM-CITY', party: L('1 night · to book', '1 คืน · รอจอง') }, notes: L('Pick a central spot (Shimotori/Karashima or by Kumamoto Stn) — hotel still to be decided.', 'เลือกทำเลกลาง (ชิโมโทริ/คาราชิมะ หรือใกล้สถานีคุมาโมโตะ) — ยังไม่ได้เลือกที่พัก') } },
    ...
    // ───────────────────────── DAY 3 · ASO & KUROKAWA ─────────────────────────
    {
      label: 'Day 03', labelTh: 'วันที่ 03', theme: 'hisui',
      date: L('Sunday · 6 Dec 2026', 'อาทิตย์ · 6 Dec 2026'),
      title: L('Aso & Kurokawa', 'อาโซ & คุโรคาวะ'),
      subtitle: L('Caldera Drive & Onsen Village', 'ขับชมปากปล่อง & หมู่บ้านออนเซน'),
      note: L(
        'Check out and drive up into the largest caldera in Japan — rim viewpoints, grasslands and the smoking crater — then over to the hidden onsen village of Kurokawa for a night in a ryokan.',
        'เช็คเอาท์แล้วขับขึ้นสู่ปากปล่องภูเขาไฟที่ใหญ่ที่สุดในญี่ปุ่น — จุดชมขอบปล่อง ทุ่งหญ้า และปล่องที่ยังคุกรุ่น แล้วข้ามไปนอนที่หมู่บ้านออนเซนซ่อนตัวคุโรคาวะในเรียวกัง'
      ),
      coverId: 'day3-cover',
      activities: [
        { type: 'step', time: '08:00', meridiem: 'Morning', kind: 'Check-out', icon: 'luggage',
          title: L('Check out · Kumamoto hotel', 'เช็คเอาท์ · โรงแรมคุมาโมโตะ'),
          place: L('Then up to the caldera', 'แล้วขึ้นสู่ปากปล่อง'),
          blurb: L('Settle up and load the car for the drive up to Mt Aso.',
                   'เคลียร์บิลแล้วขนของขึ้นรถ ออกเดินทางขึ้นภูเขาไฟอาโซ'),
          refs: { map: 'https://maps.google.com/?q=Kumamoto+city+hotels+Shimotori' } },

        { type: 'step', time: '08:30', meridiem: 'Morning', kind: 'Transfer', icon: 'car',
          title: L('Drive Kumamoto → Aso', 'ขับคุมาโมโตะ → อาโซ'),
          place: L('~1.5 h up the mountains', '~1.5 ชม. ขึ้นภูเขา'),
          blurb: L('East and up out of the city into the great caldera.',
                   'มุ่งตะวันออกไต่ขึ้นจากตัวเมืองสู่ปากปล่องยักษ์'),
          refs: { map: 'https://maps.google.com/?q=Daikanbo+Aso', notes: L('In December the high roads can ice over — keep to Route 111 (Panorama Line).', 'เดือนธันวาคมถนนบนเขาอาจมีน้ำแข็ง ใช้เส้น Route 111 (พาโนรามาไลน์)') } },

        { type: 'feature', time: '10:30', meridiem: 'Morning', kind: 'View', imageId: 'a-d3-daikanbo',
        ...
        { type: 'feature', time: '11:30', meridiem: 'Late morning', kind: 'Dining', imageId: 'a-d3-lunch',
        ...
        { type: 'feature', time: '13:00', meridiem: 'Afternoon', kind: 'Park', imageId: 'a-d3-kusasenri',
        ...
        { type: 'feature', time: '14:00', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d3-nakadake',
        ...
        { type: 'step', time: '16:45', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          ...
          refs: { map: 'https://maps.google.com/?q=Kurokawa+Onsen+ryokan', reservation: { time: '16:45', code: 'KRW-RYO', party: L('1 night · half board', '1 คืน · รวมสองมื้อ') },
    ...
    // ───────────────────────── DAY 4 · BEPPU ─────────────────────────
    {
      ...
      activities: [
        { type: 'step', time: '08:30', meridiem: 'Morning', kind: 'Check-out', icon: 'luggage',
          ...
          refs: { map: 'https://maps.google.com/?q=Kurokawa+Onsen+ryokan', notes: L('Check-out ~10:00 · one night at Kurokawa.', 'เช็คเอาท์ ~10:00 · พักคุโรคาวะ 1 คืน') } },
...
const DESTINATION = {
  ...
  route: [
    ...
    { city: L('Aso · Kurokawa', 'อาโซ · คุโรคาวะ'), days: L('Day 3', 'วันที่ 3'), day: 2, theme: 'hisui', imageId: 'r-aso', mx: 55.5, my: 36.5 },
    { city: L('Kumamoto', 'คุมาโมโตะ'), days: L('Day 2', 'วันที่ 2'), day: 1, theme: 'kohaku', imageId: 'r-kumamoto', mx: 43.5, my: 47 },
...
const KONBINI = {
  ...
  areas: [
    ...
    { days: L('Day 03', 'วันที่ 03'), area: L('Kurokawa · Oguni', 'คุโรคาวะ · โอกุนิ'),
      stores: [
        { brand: '7-Eleven', detail: L('Oguni town · ~10 min by car', 'เมืองโอกุนิ · ~10 นาทีโดยรถ'), map: 'https://maps.google.com/?q=33.1242,131.1335' },
        { brand: 'Lawson', detail: L('Route 442 · ~12 min by car', 'เส้น 442 · ~12 นาทีโดยรถ'), map: 'https://maps.google.com/?q=33.1310,131.1490' },
      ],
      pharmacy: [ { brand: 'Cosmos', detail: L('Drugstore · Oguni · ~12 min', 'ร้านขายยา · โอกุนิ · ~12 นาที'), map: 'https://maps.google.com/?q=33.1238,131.1330' } ],
      hospital: [ { brand: 'Oguni Public Hospital', detail: L('Nearest clinic/ER · ~12 min', 'คลินิก/ฉุกเฉินใกล้สุด · ~12 นาที'), map: 'https://maps.google.com/?q=33.1255,131.1352' } ] },
...
const WEATHER = {
  ...
  days: {
    ...
    2:  { icon: 'cloudSun', hi: 13, lo: 4, label: L('Crisp city, light cloud', 'เมืองอากาศเย็นสบาย มีเมฆบาง') },
    3:  { icon: 'cloud',    hi: 8,  lo: 1, label: L('Cold highlands, flurries possible', 'ที่สูงหนาว อาจมีหิมะโปรย') },
