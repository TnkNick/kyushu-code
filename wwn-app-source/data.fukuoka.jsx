...
const TRIP = {
  ...
  meta: L('Late Autumn - Onsen & Illuminations', 'ปลายฤดูใบไม้ร่วง - ออนเซนและไฟประดับ'),
  ...
  days: [
    {
      ...
      activities: [
        ...
        { type: 'feature', time: '17:30', meridiem: 'Evening', kind: 'View', imageId: 'a-d1-illum',
          ...
          blurb: L('The lights are already on by mid-November - the giant tree at Hakata Station and a belt of light through Tenjin.',
                   'ไฟประดับเปิดตั้งแต่กลางพฤศจิกายน - ต้นไฟยักษ์หน้าสถานีฮากาตะ และไฟประดับยาวต่อเนื่องทั่วเท็นจิน'),
    ...
    },
    {
      ...
      note: L(
        'Pick up the car in Hakata and climb the Milk Road into the largest caldera in Japan - rim observatories, the grasslands, the Aso milk stand and the smoking Nakadake crater - then check in to an onsen ryokan by the caldera: red-wagyu dinner and dark-sky stars.',
        'รับรถที่ฮากาตะแล้วไต่เส้น Milk Road ขึ้นสู่ปากปล่องภูเขาไฟที่ใหญ่ที่สุดในญี่ปุ่น - จุดชมวิวขอบปล่อง ทุ่งหญ้า ซอฟต์ครีมนมอาโซ และปล่องนากาดาเกะที่ยังคุกรุ่น แล้วเข้าพักเรียวกังออนเซนริมปากปล่อง: มื้อค่ำเนื้อวากิวแดงและนอนดูดาว'
      ),
      coverId: 'day2-cover',
      activities: [
        ...
        { type: 'feature', time: '09:00', meridiem: 'Morning', kind: 'View', imageId: 'a-d2-milkroad',
          ...
          refs: { map: 'https://maps.google.com/?q=Milk+Road+Aso', notes: L('Allow ~2 h from the rental incl. photo stops - late November: the high ridge can drop near freezing, watch for ice.', 'เผื่อ ~2 ชม. จากร้านเช่ารถรวมแวะถ่ายรูป - ปลายพฤศจิกายนบนสันเขาสูงใกล้จุดเยือกแข็ง ระวังน้ำแข็ง') } },
        ...
        { type: 'feature', time: '15:00', meridiem: 'Afternoon', kind: 'Park', imageId: 'a-d3-kusasenri',
          ...
          blurb: L('A wide meadow with twin crater ponds right under Nakadake - horses graze in summer; in late November it is pale gold grass under a big sky.',
                   'ทุ่งหญ้ากว้างมีบ่อปล่องคู่อยู่ใต้นากาดาเกะพอดี - หน้าร้อนมีม้าเล็มหญ้า - ปลายพฤศจิกายนเป็นทุ่งหญ้าสีทองซีดใต้ฟ้ากว้าง'),
        ...
        { type: 'step', time: '17:30', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          ...
          refs: { map: 'https://maps.google.com/?q=Aso+onsen+ryokan', reservation: { time: '17:30', code: 'ASO-RYO', party: L('Night 2 - 1 night - to book', 'คืน 2 - 1 คืน - รอจอง') }, notes: L('Aso / Uchinomaki onsen ryokan - still to be booked.', 'เรียวกังออนเซนอาโซ / อุจิโนมากิ - รอจอง') } },
        ...
        { type: 'feature', time: '20:30', meridiem: 'Night', kind: 'View', imageId: 'a-d2-nightlife',
          ...
          blurb: L('No nightlife strip up here - soak in the open-air bath, then step out for the stars. The Aso caldera is one of Kyushu\'s best dark-sky spots on a clear winter night.',
                   'บนนี้ไม่มีย่านกลางคืน - แช่ออนเซนกลางแจ้งแล้วออกมาดูดาว - ปากปล่องอาโซเป็นจุดดูดาวที่ดีที่สุดแห่งหนึ่งของคิวชูในคืนหน้าหนาวฟ้าใส'),
    ...
    },
    {
      ...
      activities: [
        ...
        { type: 'feature', time: '13:30', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d3-ropeway',
          ...
          blurb: L('A 10-minute cable car up Mt Tsurumi for a panorama over Beppu Bay and the steaming town - clear winter air, and sometimes frosted "snow flowers" on the summit trees.',
                   'นั่งกระเช้า 10 นาทีขึ้นเขาสึรุมิ ชมวิวพาโนรามาอ่าวเบปปุและเมืองที่พ่นไอน้ำ - อากาศหน้าหนาวใส บางวันมี "ดอกไม้น้ำแข็ง" เกาะต้นไม้บนยอด'),
        ...
        { type: 'feature', time: '15:30', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d3-monkey',
          ...
          blurb: L('A hillside reserve where troops of wild Japanese macaques come down to be fed - right up close, and in winter they huddle together against the cold. The Umitamago aquarium is right next door.',
                   'เขตอนุรักษ์เชิงเขาที่ฝูงลิงแสมญี่ปุ่นป่าลงมากินอาหาร - ดูใกล้ๆ หน้าหนาวลิงจะเกาะกลุ่มกันให้อุ่น - ติดกันคืออควาเรียมอุมิตามาโกะ'),
    ...
    },
    {
      ...
      activities: [
        ...
        { type: 'step', time: '14:00', meridiem: 'Afternoon', kind: 'Check-in', icon: 'bed',
          ...
          refs: { map: 'https://maps.google.com/?q=Fukuoka+city+hotels', reservation: { time: '14:00', code: 'FUK-RETURN', party: L('Base nights 5-8 - to book', 'พักคืนที่ 5-8 - รอจอง') }, notes: L('Separate from the Monterey (night 1) - return-stay hotel still to be decided.', 'คนละที่กับ Monterey (คืน 1) - โรงแรมช่วงกลับยังไม่ได้เลือก') } },
...
const DRIVING = {
  ...
  tips: [
    ...
    { icon: 'cloud', label: L('Winter & snow', 'หน้าหนาว & หิมะ'), note: L('Late November in Aso/highlands can already ice over - ask for snow tyres, keep to Route 111 (Panorama Line), ease off on bridges.', 'ปลายพฤศจิกายนแถบอาโซ/ที่สูงอาจมีน้ำแข็งแล้ว - ขอยางหิมะ ใช้เส้น 111 (พาโนรามาไลน์) ชะลอบนสะพาน') },
  ],
};
