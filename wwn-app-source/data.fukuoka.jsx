...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      note: L(
        'Pick up the car in Hakata and climb the Milk Road into the largest caldera in Japan. Late November is past the maple season up here - what you get instead is the grassland at its best: bleached-gold slopes and silver susuki plumes across the rim - then drive north out of the caldera to Kurokawa Onsen: akaushi kaiseki, lantern-lit lanes and a village full of open-air baths.',
      ...
      activities: [
        ...
        { type: 'step', time: '12:15', meridiem: 'Midday', kind: 'Transfer', icon: 'car',
          ...
          refs: { map: 'https://maps.google.com/?q=Imakin+Shokudo+Aso', notes: L('Tickets go out from around 10:00-10:30, closed Wednesdays. If the wait is hopeless, there are other akaushi places in Uchinomaki - the beef is the point, not the queue.', 'แจกบัตรคิวราว 10:00-10:30 ปิดวันพุธ - ถ้าคิวยาวเกินไหว แถวอุจิโนมากิมีร้านอาคาอุชิอื่นอีก - จุดสำคัญคือเนื้อ ไม่ใช่การต่อคิว') } },

        { type: 'feature', time: '12:30', meridiem: 'Midday', kind: 'Sweets', imageId: 'a-d3-sweets',
          title: L('Aso Milk Factory', 'อาโซมิลค์แฟกตอรี'),
          place: L('Dairy soft cream - Aso grassland milk', 'ซอฟต์ครีมนมสด - นมทุ่งอาโซ'),
          blurb: L('Aso is grazing country - a thick, milky soft-serve and a bottle of fresh Aso milk. It sits 1.1 km from Imakin, which makes it the obvious place to kill the queue time rather than a separate stop.',
                   'อาโซคือเมืองทุ่งเลี้ยงวัว - ซอฟต์ครีมนมสดเข้มข้นกับนมอาโซสดสักขวด - อยู่ห่างจากอิมาคิงแค่ 1.1 กม. เลยเป็นที่ฆ่าเวลารอคิวที่เหมาะที่สุด ไม่ต้องนับเป็นอีกจุดแยก'),
          refs: { map: 'https://maps.google.com/?q=ASO+MILK+FACTORY+Aso', notes: L('This is ASO MILK FACTORY in Uchinomaki, NOT Aso Milk Farm in Nishihara village - that one is 20 km away on the far side of the caldera.', 'ที่นี่คือ ASO MILK FACTORY ในอุจิโนมากิ ไม่ใช่ 阿蘇ミルク牧場 ที่หมู่บ้านนิชิฮาระ - อันนั้นอยู่ไกล 20 กม. คนละฝั่งปากปล่อง') } },

        { type: 'feature', time: '13:30', meridiem: 'Afternoon', kind: 'Dining', imageId: 'a-d3-lunch',
          ...
          refs: { map: 'https://maps.google.com/?q=Imakin+Shokudo+Aso', notes: L('Lunch only. Everything after this shifts with the queue, so keep the afternoon loose.', 'เปิดเฉพาะมื้อเที่ยง - ทุกอย่างหลังจากนี้ขยับตามคิว อย่าอัดตารางบ่ายแน่นเกินไป') } },

        { type: 'feature', time: '14:45', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d2-komezuka',
        ...
        { type: 'feature', time: '15:15', meridiem: 'Afternoon', kind: 'Park', imageId: 'a-d3-kusasenri',
        ...
        { type: 'feature', time: '16:00', meridiem: 'Afternoon', kind: 'View', imageId: 'a-d3-nakadake',
        ...
        { type: 'step', time: '17:30', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          ...
          blurb: L('Leave the caldera north for Kurokawa, a cedar-lined gorge of thatched inns widely rated one of the loveliest onsen villages in Japan. About 45 min from Kusasenri - and it puts you on the Yamanami Highway, so tomorrow\'s run to Beppu drops from ~2 h to about 1 h 10.',
                   'ออกจากปากปล่องขึ้นเหนือสู่คุโรคาวะ หุบเขาต้นซีดาร์ที่มีเรียวกังหลังคาฟาง ได้ชื่อว่าเป็นหมู่บ้านออนเซนที่สวยที่สุดแห่งหนึ่งของญี่ปุ่น - ห่างจากคุซะเซนริราว 45 นาที และอยู่บนเส้นยามานามิพอดี พรุ่งนี้ขับไปเบปปุจึงเหลือราว 1 ชม. 10 นาที จากเดิม ~2 ชม.'),
          refs: { map: 'https://maps.google.com/?q=Kurokawa+Onsen', official: 'https://www.kurokawaonsen.or.jp/en/',
                  reservation: { time: '17:30', code: 'KRW-RYO', party: L('Night 2 - 1 night - to book', 'คืน 2 - 1 คืน - รอจอง') },
