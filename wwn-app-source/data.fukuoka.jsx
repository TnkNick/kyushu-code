      ...
      activities: [
        ...
        { type: 'step', time: '18:00', meridiem: 'Evening', kind: 'Check-in', icon: 'bed',
          ...
          refs: { map: 'https://maps.google.com/?q=Kurokawa+Onsen', official: 'https://www.kurokawaonsen.or.jp/en/',
                  parking: L('Ryokan lots in Kurokawa are for staying guests, so you park at Sanga rather than in the village. A booking aggregator lists 25 free spaces there but the inn does not confirm it on its own site - worth asking when you call, because the lanes around Kurokawa are narrow and the inn sits up a driveway. Day visitors use the free central lot instead: 150 spaces, about 10 minutes walk into the village.', 'ลานจอดของเรียวกังในคุโรคาวะสงวนให้แขกที่พัก เราจึงจอดที่ซังงะ ไม่ใช่ในหมู่บ้าน - เว็บจองบอกว่ามี 25 ช่องฟรี แต่เว็บทางการของเรียวกังไม่ได้ยืนยัน ควรถามตอนโทรจอง เพราะถนนแถวคุโรคาวะแคบและเรียวกังอยู่ปลายทางลาด - ส่วนคนมาเที่ยวแบบไม่ค้างใช้ลานกลางฟรี 150 ช่อง เดินเข้าหมู่บ้านราว 10 นาที'),
        ...
        { type: 'feature', time: '20:30', meridiem: 'Night', kind: 'View', imageId: 'a-d2-nightlife',
          ...
          place: L('Sanga\'s seven baths', 'เจ็ดบ่อของซังงะ'),
          blurb: L('The car stays parked. Sanga sits in forest about five minutes DRIVE from the village centre, so the lantern-lit lanes are not a walk from the inn and nobody should be driving after the sake - do the village tomorrow morning with the tegata instead. Tonight is the inn: seven baths, including private ones you can book, and a properly dark sky once you step outside.',
                   'คืนนี้จอดรถทิ้งไว้ - ซังงะอยู่ในป่า ห่างจากกลางหมู่บ้านราว 5 นาทีโดยรถ ตรอกโคมไฟจึงเดินไปไม่ถึง และดื่มสาเกแล้วไม่ควรขับ - เก็บหมู่บ้านไว้เดินเช้าพรุ่งนี้ตอนใช้เทงาตะแทน - คืนนี้อยู่ที่เรียวกัง: บ่อ 7 แบบ รวมบ่อเหมาส่วนตัวที่จองได้ และฟ้ามืดสนิทพอออกไปข้างนอก'),
          refs: { map: 'https://maps.google.com/?q=Ryokan+Sanga+Kurokawa', notes: L('If you really want the village tonight, ask the inn about a shuttle when you book - several Kurokawa ryokan run one. Otherwise it is a taxi. It gets cold and properly dark, so take a layer either way.', 'ถ้าอยากไปหมู่บ้านคืนนี้จริงๆ ตอนจองให้ถามเรียวกังเรื่องรถรับส่ง - เรียวกังคุโรคาวะหลายแห่งมีบริการ ไม่งั้นก็ต้องเรียกแท็กซี่ - อากาศเย็นและมืดจริง พกเสื้อกันหนาวไว้ไม่ว่าทางไหน') } },
      ],
    },
    {
      ...
      activities: [
        ...
        { type: 'feature', time: '12:00', meridiem: 'Midday', kind: 'Dining', imageId: 'a-d5-lunch',
          ...
          blurb: L('Dango-jiru dumpling soup and local bento at a roadside station. Now that the drive from Kurokawa is only about an hour, you will reach Beppu before midday - so this is a stretch-your-legs stop rather than a necessary one, and eating in Beppu instead is perfectly reasonable.',
                   'ซุปดังโงะจิรุกับเบนโตะท้องถิ่นที่จุดพักรถ - ตอนนี้ขับจากคุโรคาวะแค่ราวชั่วโมงเดียว จะถึงเบปปุก่อนเที่ยง จุดนี้จึงเป็นแค่ที่ยืดเส้นยืดสาย ไม่ใช่จุดที่ต้องแวะ - จะเลยไปกินที่เบปปุก็ได้'),
